...
import { EMPTY_MODEL_CAPABILITIES, normalizeModelSlug } from "@t3tools/shared/model";
...
export function getProviderModelCapabilities(
  ...
  return (
    models.find((candidate) => candidate.slug === slug)?.capabilities ?? EMPTY_MODEL_CAPABILITIES
  );
}
