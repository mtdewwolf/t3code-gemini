...
/**
 * Probes the OpenCode server health endpoint to check if it's running.
 */
...
/**
 * Creates an OpenCode SDK client by dynamically importing the SDK.
 */
export async function createClient(options: OpencodeClientOptions): Promise<OpencodeClient> {
...
/**
 * Ensures an OpenCode server is running, either by connecting to an existing
